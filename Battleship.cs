...
namespace battleShip_cmd
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            for (int n = NumbersOfSize; n == 1; n--) //variable scope issue
            {
                ...
                if (((Math.Pow(BoardSize, 2) - total) - number * n) < 0)
                {
                    ...
                    int number = Int32.Parse(Console.ReadLine()); // ask to write a correct input // variable scope issue 
                }
            ...
            for (int x = 0; x < BoardSize; x++)
            {
                ...
                board.Add('O'); // the for will creae just one row how to create a square ? <----
            }
            ...
            {  // dont remenber where this for end ...............
                ...
                if (guess_row - 1 == ship_row && guess_col - 1 == ship_col) // variable scope issue 
                {
                    ...
                    board[guess_row - 1][guess_col - 1] = "V"; // the [[]; []] // variable scope issue
                ...
                else
                {
                    ...
                    if ((guess_row - 1 < 0 || guess_row - 1 > BoardSize - 1) || (guess_col - 1 < 0 || guess_col - 1 > BoardSize - 1)) //variable scope issue
                    {
                    ...
                    else if ((board[guess_row - 1][guess_col - 1] == "X")) //variable scope issue
                    {
                    ...
                    else
                    {
                        ...
                        board[guess_row - 1][guess_col - 1] = "X"; //variable scope issue
