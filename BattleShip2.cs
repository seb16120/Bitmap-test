...
namespace battleShip_cmd
{
    ...
    static class Program
    {
        ...
        static void print_board(char[,] board)
        {
            ...
            {
                Console.WriteLine(row.Join(" ")); // maybe concatenation in C#
            }
        }
        ...
        {
            int randint2 = random1.Next(0, board.Count() - 1); // issue with object reference
        ...
        static void Main()
        {
            ...
            //char[] board = { 'O' }; //it will be a [[OOOOO],[OOOOO]] so how it work on c# //its ok now ^^
            ...
            else if (GameMode == 0)
            {
                ...
                for (int n = NumbersOfSize; n == 1; n--) //variable scope issue : i want use (1)
                {
                    ...
                    else
                    {
                        ...
                        int total1 = +number * (n); // Variable scope issue

                        Console.WriteLine(" ");


                        Console.WriteLine("number of rounds (more than " + total1.ToString() + " and less than " + (Math.Pow(BoardSize, 2)).ToString() + "): ");
